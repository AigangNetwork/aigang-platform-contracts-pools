...
var PrizeCalculator = artifacts.require('./PrizeCalculator.sol')
...
contract('Product', accounts => {
    ...
    describe('#status change', async function () {
        ...
        it('setPoolDistributing flow', async function () {            
            ...
            await poolsInstance.setPoolDistributing(poolId, distributeAmount, {
              from: owner
            })
    ...
    describe('#receiveApproval contribution', async function () {
